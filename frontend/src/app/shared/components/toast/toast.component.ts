    ...
    <div class="fixed top-4 right-4 z-50 space-y-2">
      <div 
        *ngFor="let toast of notifications" 
        ...
        <div class="p-4">
          <div class="flex items-start">
            <div class="flex-shrink-0">
              <svg [ngClass]="getIconClasses(toast.type)" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <!-- Success -->
                <path *ngIf="toast.type === 'success'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                <!-- Error -->
                <path *ngIf="toast.type === 'error'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                <!-- Warning -->
                <path *ngIf="toast.type === 'warning'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                <!-- Info -->
        ...
        <!-- Progress bar -->
        <div *ngIf="toast.duration" class="bg-gray-200 h-1">
          <div 
            [ngClass]="getProgressClasses(toast.type)"
...
export class ToastComponent implements OnInit {
  @Input() notifications: ToastNotification[] = [];
